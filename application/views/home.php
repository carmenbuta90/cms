  ...
  <body>
    ...
    <div class="container">
      <div class="header clearfix">
        ...
        <h3 class="text-muted"><img class="logo" src="<?php echo base_url();?>assets/img/<?php echo $this->global_data['logo'];?>" alt ="<?php echo $this->global_data['site_title'];?>"/></h3>
      </div>

      <div class="jumbotron">
        <h1><?php echo $this->global_data['jumbotron_heading'];?></h1>
        <p><?php echo $this->global_data['jumbotron_text'];?></p>
