                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input name="title" type="text"  class="form-control" value="<?php echo $article->title;?>" placeholder="Enter site title" >                       
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="body" type="text" rows="10" class="form-control"><?php echo $article->body;?></textarea>
                            </div>
                            <div class="form-group ">
                                <label>Access</label>
