                      ...
                      <table class="table table-striped">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a href="<?php echo base_url();?>admin/users/edit/<?php echo $category->id;?>" class="btn btn-primary" >Edit</a>
                                      <a href="<?php echo base_url();?>admin/users/delete/<?php echo $category->id;?>" class="btn btn-danger" >Delete</a></td>
                              </tr>
                              <?php endforeach;?>
                          </tbody>
                      </table>
